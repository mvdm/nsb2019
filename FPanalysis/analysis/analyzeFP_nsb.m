...
%Clear workspace
clearvars -except answer FPfiles FPpath

%Select Parameter files
cd(['C:\Users\MBLUser\Desktop\NSB19_mouse\matlab\FPanalysis\analysis\']);
[paramFiles,paramPath] = uigetfile('*.m','Select FP Parameters File','MultiSelect','Off');
%paramFiles = ['NSB_FPparams.m'];
%paramPath = ['C:\Users\MBLUser\Desktop\NSB19_mouse\matlab\FPanalysis\analysis\'];
